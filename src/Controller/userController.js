...
//         const findUser = await userModel.findOne({ email: userName.toLowerCase().trim(), password: password, });
...
//         res.status(200).send({ status: true, message: "Login successful", requestBody: {userID,token} });
